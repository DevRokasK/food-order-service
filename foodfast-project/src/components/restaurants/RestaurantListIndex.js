...
export default function RestaurantListIndex(props) {
    const getImageByIndex = (index) => {
        const images = [
          ...
          'https://img.freepik.com/free-photo/front-view-yummy-french-fries-with-cheeseburgers-dark-background-snack-dish-fast-food-toast-burger-dinner_140725-158687.jpg?w=1800&t=st=1684167598~exp=1684168198~hmac=d222e188ef39bbd184d22dd4a77e5d2e2b090cea13e54190ab428211f8368ffa',
        ];
        const imageIndex = index % props.restaurants.length;
        return images[imageIndex];
      };

    return (
        <div className='cardGrid'>
            {props.restaurants.filter((restaurant) => (restaurant.available === 1)).map((restaurant, index) => (
                <RestaurantItem
                    key={restaurant.id}
